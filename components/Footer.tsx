        ...
        <div className="footer-layout" style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '80px', marginBottom: '80px' }}>
          <div className="footer-brand">
            ...
            <div className="social-links" style={{ marginTop: '24px', display: 'flex', gap: '16px' }}>
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/ziro.market" target="_blank" rel="noopener noreferrer" className="social-link" style={{ color: 'var(--text-4)', transition: 'all 0.3s ease' }} aria-label="Follow us on Instagram">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
