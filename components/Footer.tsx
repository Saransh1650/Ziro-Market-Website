      ...
      <div className="container">
        <div className="footer-layout" style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr', gap: '80px', marginBottom: '80px' }}>
          <div className="footer-brand">
            ...
            <p style={{ color: 'var(--text-3)', lineHeight: 1.6, fontSize: '0.95rem', maxWidth: '320px' }}>
              India&apos;s most powerful market intelligence platform designed for the modern retail investor. Real signals, zero noise.
            </p>
          ...
          <div className="footer-col" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <a href="mailto:hello@smartmoneytracker.in" className="footer-link">Contact Support</a>
        ...
        <div className="footer-bottom" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '40px' }}>
          <div className="footer-disclaimer" style={{ fontSize: '0.75rem', color: 'var(--text-4)', lineHeight: 1.6, maxWidth: '800px' }}>
            Smart Money Tracker (SMT) is an educational and analytical platform providing market data for informational purposes only. We do not provide investment advice or recommendations. SEBI Registration: Not Applicable. Stock market investments are subject to market risks; read all scheme related documents carefully before investing.
          </div>
          <div style={{ textAlign: 'right', flexShrink: 0 }}>
            <div style={{ fontSize: '0.85rem', color: 'var(--text-4)', marginBottom: '8px' }}>© 2026 Smart Money Tracker Pvt. Ltd.</div>
