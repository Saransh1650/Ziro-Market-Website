...
The 2026 cycle is a useful example of how quickly the framing can change. **The June 2026 dot plot reportedly showed nine participants projecting at least one hike during the year, eight projecting no change, and one still projecting a cut**, which is close to an evenly split committee rather than a settled direction. By September, after a run of firmer inflation data and an energy shock, futures pricing had moved well ahead of that June median.
