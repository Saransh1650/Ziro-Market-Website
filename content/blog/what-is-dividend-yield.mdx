...
<Logo src="/images/photos/dalal-street-sign.jpg" alt="The Dalal Street sign in Mumbai, the market where Indian dividend yields are set by price rather than by the payout" width={680} caption="Yield moves when the price moves, not only when the dividend does." credit="Photo: Nick Gray / Wikimedia Commons, CC BY-SA 2.0" />
