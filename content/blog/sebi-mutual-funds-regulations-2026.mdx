...
A further change has since taken effect: from 1 September 2026 every new single-holder demat account and mutual fund folio must carry either a nomination or a signed opt-out, covered in our [SEBI nomination rules](/blog/sebi-nomination-rules-2026-demat-mutual-fund) explainer.
