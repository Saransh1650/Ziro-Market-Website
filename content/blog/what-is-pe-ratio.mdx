...
<Logo src="/images/photos/dalal-street-sign.jpg" alt="The Dalal Street sign in Mumbai, the market where Indian price to earnings multiples are set every trading day" width={680} caption="Dalal Street, Mumbai. Every multiple discussed here is set here." credit="Photo: Nick Gray / Wikimedia Commons, CC BY-SA 2.0" />
...
Context beats theory here. **The Nifty 50 closed at 23,346.40 on 18 September 2026, roughly 11.5% below its record close of 26,373.20 set on 5 January 2026**, so index-level multiples have compressed alongside the price while earnings estimates have not fallen as far.
