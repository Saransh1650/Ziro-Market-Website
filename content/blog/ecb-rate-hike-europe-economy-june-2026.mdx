...
<StatGrid>
  <Stat value="+25 bps" label="ECB rate move" />
  <Stat value="3.0%" label="2026 inflation" />
  <Stat value="0.8%" label="2026 GDP growth" />
  <Stat value="+0.6%" label="Spain, top performer" trend="up" />
</StatGrid>

<Callout type="risk" title="The stagflation trap">

Raising rates fights inflation but slows growth further. With the eurozone already crawling at 0.8%, the ECB risks tipping a near-stalled economy into contraction while still battling 3% inflation.
