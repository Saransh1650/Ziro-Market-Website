...
seoTitle: "India Crypto Rules 2026 | What's Legal Now"
date: "2026-09-20"
...
faq:
  ...
  - q: "What is SEBI's proposed multi-regulator framework for crypto?"
    a: "SEBI has proposed a model where crypto assets are regulated by multiple agencies: SEBI would oversee crypto exchanges and security-like tokens (those that represent shares of a company or investment contracts); the RBI would handle cross-border crypto flows and stablecoin oversight; and the Ministry of Finance would set overall policy. This contrasts with the current fragmented arrangement where no single regulator has full authority."
  - q: "Why did the RBI block the crypto discussion paper in April 2026?"
    a: "The RBI has consistently opposed legalising private cryptocurrencies on the grounds that they pose risks to monetary stability, financial stability, and are potential vehicles for money laundering and capital flight. In April 2026, the RBI reportedly blocked a government-prepared discussion paper on crypto policy from being released publicly, continuing its position that broad crypto regulation should not be rushed. This represents an ongoing institutional conflict between the Finance Ministry's more pragmatic approach and the RBI's more cautious stance."
...
<Logo src="/images/photos/us-capitol.jpg" alt="The United States Capitol, where crypto market structure legislation stalled in September 2026" width={680} caption="US legislation stalled in September 2026, leaving India's own framework to develop separately." credit="Photo: Diliff / Wikimedia Commons, CC BY 2.5" />
