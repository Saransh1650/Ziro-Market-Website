...
The theme just took its biggest institutional leap yet: DTCC, the settlement giant behind most US securities trades, picked the Stellar blockchain to tokenize Russell 1000 stocks, major ETFs, and US Treasuries, targeting a live launch in H1 2027. The news sent Stellar's XLM token up over 30% in a day. See our full breakdown in [DTCC picks Stellar to tokenize Wall Street](/blog/dtcc-stellar-tokenization-xlm-xrp-2026).
