...
The concentration the cap targets is still there. In August 2026 PhonePe handled 45.9% of UPI transactions and Google Pay 32.4%, a combined 78.3%, with Paytm at 8.1% and Navi rising to 4.4% from 3.7% in June, according to NPCI data. Both leaders would have to shed volume to meet a 30% ceiling.
...
<Logo src="/images/photos/bhim-upi-qr-code.jpg" alt="A BHIM UPI QR code accepting payments at a monument ticket counter in Bhopal, the kind of scan-to-pay code behind UPI's 24.51 billion transactions in August 2026" width={680} caption="A BHIM UPI code at a ticket counter in Bhopal. Codes like this one, printed on paper and taped to a wall, now carry about 791 million payments a day." credit="Photo: Suyash.dwivedi / Wikimedia Commons, CC BY-SA 4.0" />
