...
<Callout type="note" title="Update, 17 September 2026: prices have moved well past these levels">

The thresholds discussed below, including the $62,000 support and the $72,000 recovery marker, belong to the first half of 2026. Bitcoin traded near **$76,300** in mid-September 2026 after a rally through late August, and the two macro catalysts since then were the failed CLARITY Act vote on 15 September and the Federal Reserve's 25 basis point hike to 3.75% to 4.00% on 16 September. Treat the analysis here as a study of how ETF flows behaved during that drawdown rather than as a live price view.
...
US spot Bitcoin ETFs saw $3.4 billion of net outflows in a single week in early June 2026, the largest since launch, part of a 13-day streak that pulled $4.4 billion before a partial reversal on June 12. BlackRock's IBIT lost $980 million in its worst week ever. The takeaway: Bitcoin now trades like a macro risk asset, moving on Fed policy, yields and geopolitics.
...
<Logo src="/images/photos/bitcoin-physical-coin.jpg" alt="A physical bitcoin token, illustrating this analysis of Bitcoin ETFs see $3.4 billion record weekly outflow in June 2026, Blac" width={680} caption="Crypto trades on rate expectations and regulation more than on its own news cycle." credit="Photo: AntanaCoins / Wikimedia Commons, CC BY-SA 3.0" />
...
Indirectly, IBIT flows signal institutional Bitcoin sentiment, which drives Bitcoin's global price. Indian exchanges price BTC in USDT which tracks international prices. Indian investors cannot directly buy IBIT through domestic channels. For where bitcoin goes from here, and the catalysts that decide it, see our [bitcoin H2 2026 outlook](/blog/bitcoin-h2-2026-range-breakout).
