...
$80+ billion in US Bitcoin ETFs creates structural demand specifically for Bitcoin, raising the floor for Bitcoin dominance compared to pre-ETF cycles. This may mean altcoin season 2027 (if it comes) has a higher baseline Bitcoin dominance and a smaller altcoin premium than the 2021 cycle. For the catalysts that could break bitcoin out of its range in the second half of the year, see our [bitcoin H2 2026 outlook](/blog/bitcoin-h2-2026-range-breakout), and for whether the alts are set to run, our [is altcoin season coming in 2026?](/blog/altcoin-season-2026) analysis.
