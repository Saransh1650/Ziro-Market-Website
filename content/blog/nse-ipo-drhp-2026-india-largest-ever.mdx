...
category: "event"
type: "news"
excerpt: "SEBI cleared it, the RHP is filed, and the price band is due 11 September. Here is the timeline and the catch in the numbers."
...
SEBI issued its observation letter on **4 September 2026** and the **red herring prospectus has now been filed**. The **price band is expected on 11 September**, with reported indicative ranges spanning **Rs 1,800 to Rs 2,300 per share** depending on the source. Latest reports put the subscription window around **21 to 23 September** and listing around **25 September**, a little later than the mid-September opening first indicated. Nothing is final until NSE confirms it, so treat every date and price here as tentative.
