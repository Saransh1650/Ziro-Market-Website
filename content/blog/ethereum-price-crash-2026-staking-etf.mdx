...
seoTitle: "Ethereum Price 2026 | Why ETH Fell 46%"
date: "2026-06-12"
category: "event"
type: "news"
...
This is not investment advice. Key factors for Indian investors to consider: 30% flat tax on gains with no loss-offset against other income; ETH's recovery depends on macro improvement (Iran deal, Fed cuts) and Ethereum-specific fundamentals (DeFi growth, staking yield competitiveness); volatility remains extreme in both directions. For a forward view on whether ETH can close the gap with bitcoin, see our [Ethereum 2026: can ETH catch bitcoin?](/blog/ethereum-2026-vs-bitcoin) piece.
