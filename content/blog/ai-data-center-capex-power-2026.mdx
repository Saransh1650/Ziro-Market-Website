...
The five largest hyperscalers plan to spend nearly $690 billion on infrastructure in 2026, almost all of it on AI. The bottleneck is no longer demand or chips but electricity: the AI build-out has hit a power wall, making reliable, ideally green, power the real constraint on how fast it can grow.

</Callout>

<Callout type="insight" title="Update, 5 September 2026: the spending is still accelerating">

Nvidia reported Q2 FY27 revenue of **$96.22 billion** on 26 August 2026, more than double the $46.7 billion of a year earlier, and guided the current quarter to **$108 billion plus or minus 2%**, roughly 4% above analyst expectations. That is the clearest evidence yet that hyperscaler AI capex has not begun to slow, which keeps the power-supply constraint this piece describes as the binding one rather than demand.
...
<Logo src="/images/photos/data-center-server-room.jpg" alt="Rows of servers in a data centre, the hardware absorbing the global AI capital expenditure cycle" width={680} caption="Where the capex goes." credit="Photo: BalticServers.com / Wikimedia Commons, CC BY-SA 3.0" />

**The money has started moving down the stack.** Blackstone agreed to buy a data centre liquid cooling components maker on 10 September 2026 and Flex agreed to pay about $4.4 billion for power conversion specialist EPC Power, deals our [AI cooling and power](/blog/ai-cooling-power-deals-2026-new-ai-trade) piece unpacks.

**Oracle is the single sharpest example of the funding gap**, with capital expenditure of $55.7 billion in one quarter and about $70 billion guided for FY2027, covered in our [Oracle AI backlog](/blog/oracle-ai-backlog-638-billion-cash-burn-2026) analysis.

<BarChart
  title="Planned 2026 AI infrastructure spend, by hyperscaler"
  unit="$"
  data={[
    { label: 'Amazon', value: 200 },
    { label: 'Alphabet', value: 180 },
    { label: 'Meta', value: 125 },
    { label: 'Microsoft', value: 120 },
    { label: 'Oracle', value: 50 },
  ]}
  caption="Approximate 2026 capex guidance, in US$ billion. Combined hyperscaler total near $690 billion."
/>
...
Yes. It drives revenue for chipmakers, power suppliers, and builders, lifting many stocks. But the scale assumes AI revenue will justify it. If returns disappoint, the capex could be cut sharply, which is central to the [AI bubble debate](/blog/ai-bubble-2026-will-it-burst). For the Indian side of the build-out, and how to play it with Indian stocks, see our [India data center boom 2026](/blog/india-data-center-boom-2026) piece.
